        ...
        if login_btn:
            if email and password:
                try:
                    ...
                    print(f"[Login Error] {str(e)}")  # Logs the error to the terminal
...
def login_user(email, password):
    ...
    try:
        ...
        user_id = account_info['users'][0]['localId']  # This is the unique Firebase UID
        ...
        st.session_state.user_id = user_id  # ✅ Store unique UID
        ...
        # Optionally: st.error(f"Login failed: {e}")
